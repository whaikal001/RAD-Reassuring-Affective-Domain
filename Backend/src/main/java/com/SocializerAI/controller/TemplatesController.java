...
import com.SocializerAI.dto.TemplateClickRequest;
import com.SocializerAI.dto.TemplateDTO;
import com.SocializerAI.service.EmotionTrackingService;
...
public class TemplatesController {
    ...
    public Map<String, Object> trackClick(@RequestBody TemplateClickRequest req) {
        try {
            ...
            emotionTrackingService.recordEmotion(null, req.getScenarioId(), scaled, req.getMessageText(), "dass_template");
        } catch (Exception e) {
